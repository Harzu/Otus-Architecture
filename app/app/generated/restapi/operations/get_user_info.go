...
type GetUserInfoHandlerFunc func(GetUserInfoParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetUserInfoHandlerFunc) Handle(params GetUserInfoParams) middleware.Responder {
	return fn(params)
}

// GetUserInfoHandler interface for that can handle valid get user info params
type GetUserInfoHandler interface {
	Handle(GetUserInfoParams) middleware.Responder
}
...
/*GetUserInfo swagger:route GET /users/me getUserInfo
